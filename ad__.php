...
<body>
            ...
            <ul class="list">
                ...
                <div class="search">
                    <form method="POST" action="info.php">
                        ...
                        <input type="image" name="submit_p" src="images/searchicon.png" alt="Search image" style="width: 10px;;height: 10px;; margin-left: 35px;">
                    </form>
                </div>
            </ul>
            <ul class="list2">
    ...
    <tr>
        ...
        <td>
            <form method="POST" action="admin_op.php" onsubmit="return confirm('Are you sure you want to delete this customer?');">
                <input type="hidden" name="id" value="<?php echo $rows['id']; ?>">
                <input type="submit" name="de-submit-c" value="Delete">
            </form>
        </td>
    </tr>
    <?php } ?>
                ...
                <table align="center" border="1px" style="width: 500px; line-height: 30px;">
                    ...
                    <?php while($rows2 = mysqli_fetch_assoc($result2)) { ?>
                        <tr>
                            ...
                            <td><img src="<?php echo $rows2['image']; ?>" width="100" height="80"></td>

                    <td>
            <form method="POST" action="admin_op.php" onsubmit="return confirm('Are you sure you want to delete this place?');">
                <input type="hidden" name="pid" value="<?php echo $rows2['pid']; ?>">
                <input type="submit" name="de-submit-p" value="Delete">
            </form>
            ...
            <div class="insert-form" id="ins-form2">
                <form method="POST" action="admin_op.php">     
                    ...
                    <input type="text" name="pcity" placeholder="City" required><br>
                     <input type="text" name="image" placeholder="Image filename (e.g., place1.jpg)" required><br>
...
<div class="addp-workspace work" id="id5" style="display: none;">
    <div class="insert-pform" id="insp-form4">
        <form method="POST" action="admin_op.php">
            <input type="text" name="pname" placeholder="Place Name" required><br>
            <textarea name="destination" rows="4" placeholder="Place description" required></textarea><br>
            <input type="text" name="image" placeholder="Image URL or filename" required><br>
            <input type="number" name="package" placeholder="Package Price" required><br>
